...
## Scope
- Extract GRBL protocol/state-machine code needed for connection, status updates, jogging, streaming, hold/resume/reset, queue handling, overrides, configuration parsing, and emulator-driven workflows.
